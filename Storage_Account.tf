resource "azurerm_storage_account" "storageaccuat01" {
  name                     = "storageaccuat01"
...
resource "azurerm_storage_container" "container-uat-01" {
  ...
  storage_account_id    = azurerm_storage_account.storageaccuat01.id
  container_access_type = "private"
}

/*resource "azurerm_storage_blob" "blob-uat-01" {
  name                   = "blob-uat-01"
  storage_account_name   = azurerm_storage_account.storageaccuat01.name
